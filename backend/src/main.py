...
async def lifespan(app: FastAPI):
    logger.info("=" * 60)
    logger.info("HealerDB starting up")
    ...
    #  Shutdown 
    logger.info("HealerDB shutting down...")
    ...
    logger.info("HealerDB shutdown complete")


app = FastAPI(
    title="HealerDB",
    description="Autonomous self-healing database monitoring and repair system",
    version="0.4.0",
    lifespan=lifespan,
)
