...
_CREATE_TABLE_SQL = """
CREATE TABLE IF NOT EXISTS _healerdb_audit (
...
async def init_audit_table():
    ...
    try:
        ...
        logger.info("[AuditLog] Table _healerdb_audit ready")
